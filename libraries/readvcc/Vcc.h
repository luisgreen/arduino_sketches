...
class Vcc
{
  public:
	...
	/**
	* Retrieve a battery icon associated with a specific voltage.
	* > 4.95v is considered External power, minimum is 3.5v, below that Arduino fails and reboot itself.
	*/
	byte* Get_Battery_Icon(const int selectedIcon = -1);
	
	/**
	* List of battery icons for LCD 1602 Screens
	*/
	static byte Icon[9][8];
