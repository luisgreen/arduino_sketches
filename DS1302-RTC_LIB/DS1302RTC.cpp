...
#define DS1302_TRICKLE_WRITE     0x91
...
DS1302_RTC::DS1302_RTC(uint8_t inSCLK, uint8_t inIO, uint8_t inC_E)   {
  SCLK = inSCLK;
  IO = inIO;
  C_E = inC_E;
  _write (DS1302_ENABLE, 0);                         // Sets the Clock Enable to ON.
  _write (DS1302_TRICKLE_WRITE, 0x00);               // Disable Trickle Charger.
}
//=======================================================================================================
//
//                                        DS1302_RTC Function End
//
//=======================================================================================================
//
//
...
void DS1302_RTC::clock_burst_read( uint8_t *p)  {
  int i;
  _start();
...
//=======================================================================================================
//
//                             clock_burst_write Function Begin
//
//=======================================================================================================
//
...
void DS1302_RTC::clock_burst_write( uint8_t *p)  {
  int i;
  _start();
...
uint8_t DS1302_RTC::_read(int address)  {
  uint8_t data;
...
void DS1302_RTC::_write( int address, uint8_t data)  {
...
//=======================================================================================================
//                                  _DS1302togglewrite Function Begin
//=======================================================================================================
...
void DS1302_RTC::togglewrite( uint8_t data, uint8_t release)  {
  int i;
...
void DS1302_RTC::setDS1302Time(uint8_t seconds, uint8_t minutes, uint8_t hours, uint8_t dayofweek,
...
//
void DS1302_RTC::updateTime() {
  clock_burst_read( (uint8_t *) &rtc);                      // Read all clock data at once (burst mode).
